...
class Embedding(nn.Embedding):
    r"""A simple extension of :class:`torch.nn.Embedding` with a configurable initializer.

    The learnable weights of the module, of shape `(num_embeddings, embedding_dim)`, are
    initialized from :math:`\mathcal{N}(0, \text{init_scale})`.
